...
// import {FcGenericSortingAsc, FcGenericSortingDesc} from 'react-icons/fc'
// import Header from '../Header'
// import TotalStats from '../TotalStates'
// import Footer from '../Footer'
...
//         const stateTotal = data[stateCode].total
//         const activeCases =
//           stateTotal.confirmed - (stateTotal.recovered + stateTotal.deceased)
//         return {
//           stateName,
//           stateCode,
//           confirmed: stateTotal.confirmed,
//           deceased: stateTotal.deceased,
//           recovered: stateTotal.recovered,
//           active: activeCases,
...
//   onChangeInput = event => {
//     if (event.target.value === '') {
//       this.setState({searchInput: event.target.value, isSearching: false})
//     } else {
//       this.setState({searchInput: event.target.value, isSearching: true})
//     }
//   }
...
//         {data.map(eachData => (
//           <SearchResults key={eachData.state_code} states={eachData} />
//         ))}
//       </ul>
//     </>
//   )
...
//     const searchResults = statesList.filter(item =>
...
//           />
//         </div>
//         {searchInput.length > 0 ? this.showSearchResults(searchResults) : ''}
//       </>
//     )
//   }
...
//             {isSearching ? '' : this.renderAllViews()}
//           </div>
//         </div>
//         <Footer />
//       </>
