...
// const StateTotalData = props => {
//   const {tabData, changeActiveTabId, isActive} = props
//   const {id, name, logo, value} = tabData

//   const onClickTab = () => {
//     changeActiveTabId(id)
//   }

//   const activeIsLoading = isActive ? 'confirmed-block' : ''
...
//         <button
//           type="button"
//           className={`category-item ${id} ${name} ${activeIsLoading}`}
//           onClick={onClickTab}
//         >
//           <div>
//             <p className="state-heading">{name}</p>
//             <img
//               src={logo}
//               alt={`state specific ${id} cases pic`}
//               className="state-img"
//             />
//             <p className="state-value">{value}</p>
//           </div>
//         </button>
//       </li>
//     </>
